...
df = pd.read_csv("MW_38_24_25.csv").set_index("MatchWeek")
...
bcr.bar_chart_race(
    ...
    colors=['#EF0107', '#95BFE5', '#8B0304', '#FFB400', '#0057B8', '#034694', '#003399', '#000000', '#DE2C37', '#003090',
            '#D00027', '#6CADDF', '#DA020E', '#231F20', '#DD0000', '#1B458F', '#D71920', '#132257', '#7C2C3B', '#FDBC02'],
    # title and its styles
    title={'label': 'EPL Top Half 2023/24',
           'size': 52,
           'weight': 'bold',
           'pad': 40
           },
    ...
    period_label={'x': .95, 'y': .18,
                  'ha': 'right',
                  'va': 'center',
                  'size': 72,
                  'weight': 'semibold'
                  },
    period_summary_func=lambda v, r: {'x': .99, 'y': .1, 's': f'@kioko_steve', 'ha': 'right', 'size': 24,
                                      'weight': 'normal'},
